...
final class DrawBench
{
    ...
    public function provideCampaignRequests(): iterable
    {
        ...
        yield 'campaign.run' => $this->request(
            method: 'campaign.run',
            items: [
        ...
        yield 'campaign.batch' => $this->request(
        ...
        yield 'campaign.simulate' => $this->request(
    ...
    public function provideItemRequests(): iterable
    {
        ...
        yield 'probability' => $this->request(
            method: 'probability',
            items: [
        ...
        yield 'elimination' => $this->request(
            method: 'elimination',
            items: [
                ['name' => 'item1'],
                ['name' => 'item2'],
        ...
        yield 'weightedElimination' => $this->request(
        ...
        foreach (['roundRobin', 'cumulative', 'sequential'] as $method) {
            yield $method => $this->request(
                method: $method,
                items: $simpleItems,
                options: ['count' => 3],
            );
        ...
        yield 'weightedBatch' => $this->request(
        ...
        yield 'rangeWeighted' => $this->request(
